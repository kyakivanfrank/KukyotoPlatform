...
<nav className="navbar navbar-expand-lg navbar-light">
  ...
  <button onClick="./StartPage" className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
